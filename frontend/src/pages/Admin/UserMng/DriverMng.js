...
import { getDriverAction, xoaNguoiDungAction } from '../../../redux/actions/DriverAction';
...
// }
  ...
  const columns = [
    ...
    },
    {
      ...
      : <Avatar size={40} style={{ fontSize: '20px', display: 'flex', justifyContent: 'center', alignItems: 'center' }} icon={movie.fullName.substr(0, 1)} />}
    },
    {
      title: 'Full Name',
      dataIndex: 'fullName',
  ...
  return <div>
    <div className='d-flex mb-3'>
      ...
      <Button href='/admin/users/adduser' type="primary" className='ml-3 small bg-primary'>+ Add New Driver</Button>
    </div>
