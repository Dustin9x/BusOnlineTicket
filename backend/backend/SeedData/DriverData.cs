...
namespace backend.SeedData
{
    public class DriverData
    {
        public static Driver[] DriverSeedData()
        {
            return new Driver[]
            {
                    new Driver {Id=1,Avatar="driver1.png",DriverLicense="234567",Email="driver1@phtv.com",Password=BCrypt.Net.BCrypt.HashPassword("driver1@phtv.com"),FullName="Nguyen Van Toan",NationalId="2345678",Phone="090123456",PlaceOfBirth="Ho Chi Minh",Enabled=true,YearOfBirth=new DateTime(1995, 12, 25)},
                    new Driver {Id=2,Avatar="driver2.png",DriverLicense="234567",Email="driver2@phtv.com",Password=BCrypt.Net.BCrypt.HashPassword("driver2@phtv.com"),FullName="Le Huy Phu",NationalId="2345678",Phone="090123456",PlaceOfBirth="Lam Dong",Enabled=true,YearOfBirth=new DateTime(1998, 07, 12)},
                    new Driver {Id=3,Avatar="driver3.png",DriverLicense="234568",Email="driver3@phtv.com",Password=BCrypt.Net.BCrypt.HashPassword("driver3@phtv.com"),FullName="Bui Quoc Viet",NationalId="2345679",Phone="090123457",PlaceOfBirth="Binh Thuam",Enabled=true,YearOfBirth=new DateTime(1993, 07, 06)},
                    new Driver {Id=4,Avatar="driver4.png",DriverLicense="234569",Email="driver4@phtv.com",Password=BCrypt.Net.BCrypt.HashPassword("driver4@phtv.com"),FullName="Pham Huy Hoang",NationalId="2345670",Phone="090123458",PlaceOfBirth="Gia Lai",Enabled=true,YearOfBirth=new DateTime(1990, 09, 05)},
                    new Driver {Id=5,Avatar="driver5.png",DriverLicense="234560",Email="driver5@phtv.com",Password=BCrypt.Net.BCrypt.HashPassword("driver5@phtv.com"),FullName="Le Huy Chuong",NationalId="2345671",Phone="090123459",PlaceOfBirth="Vung Tau",Enabled=true,YearOfBirth=new DateTime(1999, 12, 24)},
