    ...
    return (
        <div className="mt-3">
            <div className="row p-4 rounded-xl bg-white">
                <h2 className="text-lg">PHTV Online Bus Booking Services</h2>
                <p className="text-gray-500 text-sm">
                    PHTV Bus is India`s leading online bus ticket booking service
                    provider. Check out budget friendly offers and save big with discount
                    coupons to book bus tickets at the lowest price with us. You can check
                    the bus schedules, compare prices, and find all the information you
                    need to plan an ideal and comfortable bus or train journey.
                </p>
                <p className="text-gray-500 text-sm">
                    PHTV Bus has simplified the online bus booking process for your travel
                    planning. In case you need to cancel the ticket or change the dates,
                    You can save both time and money by choosing AbhiCash as a refund
                    option which can be used instantly. Book now!!!
                </p>
                <p className="text-gray-500 text-sm">
                    Browse through all your bus route options, and use our advanced smart
                    filters to ensure a reliable and comfortable journey, tailored to your
            ...
            <div className="row p-4 rounded-xl bg-white mt-3">
                <h2 className="text-lg">Benefits of Booking Bus Tickets Online</h2>
                <p className="text-gray-500 text-sm">
            ...
            <div className="row p-4 rounded-xl bg-white mt-3">
                ...
                <div className="container">
                    <ul className="text-gray-500 text-sm">
                        ...
                        <li>Complete the payment process by selecting your preferred mode of payment</li>
                    </ul>
                </div>
                <p className="text-gray-500 text-sm">
